    ...
    },
    {
      ...
      effects: {
        rob_foreign: (gameState) => {
          ...
          if (roll <= 3) {
            // Order retaliates immediately! Replace current event with Order attack
            return {
              ...gameState,
              currentEvent: {
              ...
              eventResolved: false,
              lastEventResult: `Merchants robbed! The Order is enraged (rolled ${roll}/6) and attacks immediately with 100 strength!`
            };
          } else {
